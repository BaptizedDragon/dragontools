...
const overview = std.fmt.comptimePrint(
    ...
    \\  Access with an explicit SSH tunnel. The official VictoriaLogs plugin is pinned; managed VMUI and Grafana dashboards are available.
