...
pub const Check = enum {
    ...
    host_events_account,
    host_events_helper,
    host_events_state_directory,
    host_events_service_unit,
    host_events_timer_unit,
    host_events_timer_enabled,
    host_events_timer_active,
    host_events_last_run,
    host_events_state_safe,
